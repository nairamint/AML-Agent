 ...
 * Simple AML Test
 * 
 * Tests with a simpler prompt that works with the model
 */
...
async function testSimpleAMLQuery() {
  console.log('🚀 Simple AML-KYC Advisory Test\n');
  
  console.log('✅ Using working model:', WORKING_MODEL);
  console.log('🔍 Testing simple AML compliance query...\n');
  ...
  const testData = JSON.stringify({
    ...
    messages: [
      {
        role: "user",
        content: "What are the basic customer due diligence requirements for AML compliance? Please provide a brief summary."
      }
    ],
    max_tokens: 300,
    temperature: 0.1
